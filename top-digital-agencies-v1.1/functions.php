...
function tda_register_custom_post_types_and_taxonomies() {
    ...
    register_post_type( 'partner_logo', array(
        'labels'             => array(
            'name'               => _x( 'Partner Logos', 'post type general name', 'top-digital-agencies' ),
            'singular_name'      => _x( 'Partner Logo', 'post type singular name', 'top-digital-agencies' ),
            'menu_name'          => _x( 'Partner Logos', 'admin menu', 'top-digital-agencies' ),
            'add_new_item'       => __( 'Add New Partner Logo', 'top-digital-agencies' ),
        ),
        'public'             => true,
        'show_ui'            => true,
        'show_in_menu'       => true,
...
function tda_register_acf_field_groups() {
    ...
    // 3.0. Field Group: Partner Logo Fields
    acf_add_local_field_group( array(
        'key' => 'group_partner_logo_fields',
        'title' => __( 'Partner Logo Fields', 'top-digital-agencies' ),
        'fields' => array(
            array(
                'key' => 'field_logo_url',
                'label' => __( 'Logo URL', 'top-digital-agencies' ),
                'name' => 'logo_url',
                'type' => 'text',
                'instructions' => __( 'Leave empty to use text fallback (post title).', 'top-digital-agencies' ),
            ),
        ),
        'location' => array(
            array(
    ...
    acf_add_local_field_group( array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'label' => __( 'Logo Image URL', 'top-digital-agencies' ),
                'name' => 'logo_image',
                'type' => 'text',
            ),
            array(
        ...
        'fields' => array(
            array(
                ...
                'layouts' => array(
                    ...
                    // Layout: Partner Logos Band
                    'layout_logos_band' => array(
                        'key' => 'layout_logos_band',
                        'name' => 'logos_band',
                        'label' => __( 'Partner Logos Band', 'top-digital-agencies' ),
                        'display' => 'block',
                        'sub_fields' => array(
                            array(
                                'key' => 'field_logos_band_title',
                                'label' => __( 'Introductory Title', 'top-digital-agencies' ),
                                'name' => 'title',
                                'type' => 'text',
                                'default_value' => 'TRUSTED BY LEADING MOROCCAN & GLOBAL COMPANIES',
                            ),
                        ),
                    ),
                    // Layout: Challenge
...
function tda_activate_theme_automation( $force = false ) {
    if ( $force ) {
        ...
        $cpts = array( 'agency', 'specialty_hub', 'stat_metric', 'partner_logo' );
        foreach ( $cpts as $cpt ) {
    ...
    $pages_to_create = array(
        ...
        'Directory'   => array( 'template' => '', 'is_front' => false ),
        'Blog'        => array( 'template' => '', 'is_front' => false ),
        'Rankings'    => array( 'template' => '', 'is_front' => false ),
        'About'       => array( 'template' => '', 'is_front' => false ),
        'Methodology' => array( 'template' => '', 'is_front' => false ),
        'Contact'     => array( 'template' => '', 'is_front' => false ),
    );
                    ...
                    if ( $force || empty( $existing_layouts ) ) {
                        $layouts = array(
                            array(
                                ...
                                'title' => 'The Independent Directory of Top Digital Marketing Agencies in <span class="hero-location-word">Morocco</span>, <span class="hero-focus-word">Ranked<span class="text-slate-900">.</span></span>',
                            ...
                            array(
                                'acf_fc_layout' => 'logos_band',
                                'title' => 'TRUSTED BY LEADING MOROCCAN & GLOBAL COMPANIES',
                            ),
                            array(
                                'acf_fc_layout' => 'challenge',
                                'heading' => 'Most businesses hire the <span class="challenge-focus-word">wrong agency</span> within <span class="challenge-time-word">48 hours</span>.',
                            ...
                            array(
                                ...
                                'title' => 'A <span class="approach-focus-word">better way</span> to <span class="approach-action-word">choose</span> an agency.',
                            ),
                            array(
    ...
    $hubs = array(
        'SEO' => array(
            'svg' => '<svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',
            'link' => 'SEO',
            'subs' => array( 'On-Page SEO', 'Technical Audits', 'Local Search SEO', 'Link Building' )
        ),
        'Paid Ads' => array(
            'svg' => '<svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>',
            'link' => 'Paid Ads',
            'subs' => array( 'Google PPC campaigns', 'Social Ads (Meta & TikTok)', 'Retargeting funnels', 'Shopping/E-com PPC' )
        ),
        'Social Media' => array(
            'svg' => '<svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><circle cx="18" cy="5" r="3"></circle><circle cx="6" cy="12" r="3"></circle><circle cx="18" cy="19" r="3"></circle><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"></line><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"></line></svg>',
            'link' => 'Social Media',
            'subs' => array( 'Community management', 'Influencer strategy', 'Content creation', 'Social listening' )
        ),
        'Web Design' => array(
            'svg' => '<svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg>',
            'link' => 'Web Design',
            'subs' => array( 'UX/UI Wireframing', 'Responsive development', 'E-commerce engineering', 'Web performance audits' )
        ),
        'Branding' => array(
            'svg' => '<svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z"></path><path d="M12 18C15.3137 18 18 15.3137 18 12C18 8.68629 15.3137 6 12 6C8.68629 6 6 8.68629 6 12C6 15.3137 8.68629 18 12 18Z"></path></svg>',
            'link' => 'Branding',
    ...
    $logo_index = 0;
    foreach ( $partner_logos as $name => $url ) {
        $check = get_page_by_title( $name, OBJECT, 'partner_logo' );
        if ( ! $check ) {
            $logo_post_id = wp_insert_post( array(
                'post_title'  => $name,
                'post_status' => 'publish',
                'post_type'   => 'partner_logo',
                'menu_order'  => $logo_index++,
            ) );
            if ( $logo_post_id && function_exists( 'update_field' ) ) {
                update_field( 'field_logo_url', $url, $logo_post_id );
            }
        }
    }

    // Seed Agencies (All 6 agencies from static prototype)
    $agencies_to_seed = array(
        ...
        'DigitalWave' => array(
            ...
            'cases' => array(
                array( 'title' => 'Custom Headless E-shop', 'tag' => 'Web Dev' ),
                array( 'title' => 'Corporate SEO Strategy', 'tag' => 'Organic Search' ),
                array( 'title' => 'Integrated Rebranding', 'tag' => 'Brand Launch' )
            )
        ),
        'NexaMedia' => array(
            'rank' => '5',
            ...
            'reviews' => '22',
            'city' => 'Marrakech',
            'services' => array( 'Content Marketing', 'SEO', 'Social Media' ),
            'budget' => '8,000 MAD/mo',
            ...
            'cases' => array(
                array( 'title' => 'Hotel Blog Strategy', 'tag' => 'Content Marketing' ),
                array( 'title' => 'Local Map Optimization', 'tag' => 'Local SEO' ),
                array( 'title' => 'Community Launch', 'tag' => 'Social Media' )
            )
        ),
        'Sahara Digital' => array(
            'rank' => '6',
            'rating' => '4.4',
            'reviews' => '19',
            'city' => 'Agadir',
            'services' => array( 'Social Media', 'Web Design', 'Branding' ),
            'budget' => '8,000 MAD/mo',
            'project' => '20K-80K MAD',
            'team_size' => '8-12',
            'clients' => '45+',
            ...
            'cases' => array(
                array( 'title' => 'Surf Camp Branding', 'tag' => 'Identity & Social' ),
                array( 'title' => 'Resort Web Design', 'tag' => 'E-commerce Web' ),
                array( 'title' => 'Tourism Promo Ads', 'tag' => 'Paid Social' )
            )
        )
    );
...
/**
 * Trigger re-seeding when tda_reseed is passed in admin URL or query.
 */
function tda_admin_reseed_trigger() {
    // Check query arg '?tda_reseed=1' in front-end or admin
    if ( isset( $_GET['tda_reseed'] ) ) {
        // Run database seeding/re-seeding
        tda_activate_theme_automation( true );
        
        // Show status message or redirect if in admin
        if ( is_admin() && current_user_can( 'manage_options' ) ) {
            wp_safe_redirect( admin_url( '?tda_seeded=1' ) );
            exit;
        } else {
            wp_die( 'Database successfully re-seeded with Top Digital Agencies mockup layouts and CPT items! <a href="' . esc_url( home_url( '/' ) ) . '">Return to Homepage</a>' );
        }
    }
}
add_action( 'init', 'tda_admin_reseed_trigger' );
