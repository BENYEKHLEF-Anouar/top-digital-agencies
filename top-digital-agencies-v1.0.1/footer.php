        ...
        <div class="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8 py-10">
            <div class="grid grid-cols-2 md:grid-cols-6 gap-6 mb-8">
                <div class="col-span-2">
                    ...
                    <p class="text-[13px] text-slate-500 leading-relaxed max-w-sm"><?php _e( 'Morocco\'s independent directory for digital marketing agencies. Verified reviews, transparent rankings, zero paid placement.', 'top-digital-agencies' ); ?></p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-[13px]">
                        <li><a href="<?php echo esc_url( home_url( '/about/' ) ); ?>" class="text-slate-500 hover:text-slate-900 transition-colors"><?php _e( 'About', 'top-digital-agencies' ); ?></a></li>
                        <li><a href="<?php echo esc_url( home_url( '/blog/' ) ); ?>" class="text-slate-500 hover:text-slate-900 transition-colors"><?php _e( 'Blog', 'top-digital-agencies' ); ?></a></li>
                        <li><a href="<?php echo esc_url( home_url( '/methodology/' ) ); ?>" class="text-slate-500 hover:text-slate-900 transition-colors"><?php _e( 'Methodology', 'top-digital-agencies' ); ?></a></li>
                        <li><a href="<?php echo esc_url( home_url( '/contact/' ) ); ?>" class="text-slate-500 hover:text-slate-900 transition-colors"><?php _e( 'Contact', 'top-digital-agencies' ); ?></a></li>
                    </ul>
                </div>
                <div>
                    <h4 class="font-semibold text-slate-900 text-[13px] mb-3 font-display"><?php _e( 'Legal', 'top-digital-agencies' ); ?></h4>
                    <ul class="space-y-2 text-[13px]">
                        <li><a href="#" class="text-slate-500 hover:text-slate-900 transition-colors"><?php _e( 'Privacy', 'top-digital-agencies' ); ?></a></li>
                        <li><a href="#" class="text-slate-500 hover:text-slate-900 transition-colors"><?php _e( 'Terms', 'top-digital-agencies' ); ?></a></li>
                    </ul>
                </div>
            </div>
            <div class="border-t border-slate-200 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                <p class="text-[12px] text-slate-400 font-mono" id="footer-copy-text">&copy; <?php echo date( 'Y' ); ?> <?php _e( 'Agence Marketing Digital. Independent directory.', 'top-digital-agencies' ); ?></p>
        ...
        <div id="wiz-step-2" class="hidden space-y-4">
            ...
            <div class="space-y-2">
                <button onclick="selectWizardBudget(this, 'low')" class="wiz-opt-budget w-full border border-slate-200 hover:border-brand-600 hover:bg-brand-50/50 rounded-lg p-3 text-left transition-all text-[13px] font-semibold text-slate-700 flex justify-between items-center">
                    <span><?php _e( 'Under 10,000 MAD / mo', 'top-digital-agencies' ); ?></span>
                ...
                <button onclick="selectWizardBudget(this, 'mid')" class="wiz-opt-budget w-full border border-slate-200 hover:border-brand-600 hover:bg-brand-50/50 rounded-lg p-3 text-left transition-all text-[13px] font-semibold text-slate-700 flex justify-between items-center">
                    <span><?php _e( '10,000 MAD - 20,000 MAD / mo', 'top-digital-agencies' ); ?></span>
                    <i data-lucide="circle" class="w-4 h-4 text-slate-300"></i>
                </button>
                <button onclick="selectWizardBudget(this, 'high')" class="wiz-opt-budget w-full border border-slate-200 hover:border-brand-600 hover:bg-brand-50/50 rounded-lg p-3 text-left transition-all text-[13px] font-semibold text-slate-700 flex justify-between items-center">
                    <span><?php _e( 'Over 20,000 MAD / mo', 'top-digital-agencies' ); ?></span>
                    <i data-lucide="circle" class="w-4 h-4 text-slate-300"></i>
                </button>
            </div>
